...
class TestI2CTimingCalculator(TestCase):
    ...
    def test_clock_low_depends_on_scl_rise_time(self):
        ...
        test_cases = [
            {'scl_rise': 1384,
             'measured': Parameter(i2c=5600, nominal=5000, worst_case=4996),
             'expected': Parameter(i2c=5574, nominal=5000, worst_case=4996)},
            {'scl_rise': 434,
             'measured': Parameter(i2c=5150, nominal=5000, worst_case=4996),
             'expected': Parameter(i2c=5175, nominal=5000, worst_case=4996)},
            {'scl_rise': 182,
             'measured': Parameter(i2c=5060, nominal=5020, worst_case=4996),
             'expected': Parameter(i2c=5069, nominal=5000, worst_case=4996)},
            {'scl_rise': 31,
             'measured': Parameter(i2c=4990, nominal=5000, worst_case=4996),
             'expected': Parameter(i2c=5006, nominal=5000, worst_case=4996)},
        ]
        for t in test_cases:
    ...
    def test_clock_low_depends_on_prescale(self):
        ...
        test_cases = [
            {'prescale': 0,
             'measured': Parameter(i2c=3084, nominal=2510, worst_case=2496),
             'expected': Parameter(i2c=3074, nominal=2500, worst_case=2496)},
            {'prescale': 2,
             'measured': Parameter(i2c=10580, nominal=10000, worst_case=9996),
             'expected': Parameter(i2c=10574, nominal=10000, worst_case=9996)},
        ]
        for t in test_cases:
            config = self.build_config(prescale=t['prescale'], scl_risetime=1384, sda_risetime=32)
            actual = config.clock_low()

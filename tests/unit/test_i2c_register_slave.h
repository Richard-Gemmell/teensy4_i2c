#define TEENSY_I2C_UNIT_TEST_I2C_REGISTER_SLAVE_TEST
#ifdef TEENSY_I2C_UNIT_TEST_I2C_REGISTER_SLAVE_TEST
...
class I2CRegisterSlaveTest : public TestSuite {
public:
    static DummyI2CSlave* dummy;
    static uint16_t address;
    static uint8_t settings[4];
    static uint8_t filled_settings[4];
    static uint8_t blank_read_only[4];
    static uint8_t read_only[4];

    void setUp() override {
        dummy = new DummyI2CSlave();
    ...
    static void test_listen_calls_listen_on_driver() {
    ...
    static void test_master_can_write_to_mutable_register() {
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, settings, sizeof(settings), read_only, sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_master_can_write_to_multiple_registers() {
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, settings, sizeof(settings), read_only, sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_master_cannot_write_to_non_existent_register() {
        uint8_t big_settings[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        size_t claimed_settings_size = 2;
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, big_settings, claimed_settings_size, read_only,
                                                      sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_master_cannot_write_too_many_bytes_to_a_register() {
        uint8_t big_settings[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        size_t claimed_settings_size = 2;
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, big_settings, claimed_settings_size, read_only,
                                                      sizeof(read_only));
    ...
    static void test_master_ignores_repeated_write_to_mutable_register() {
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, settings, sizeof(settings), read_only, sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_master_can_write_register_in_single_transaction() {
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, settings, sizeof(settings), read_only, sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_master_can_write_to_multiple_registers_with_single_transactions() {
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, settings, sizeof(settings), read_only, sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_ignores_single_transaction_write_to_non_existent_register() {
        uint8_t big_settings[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        size_t claimed_settings_size = 2;
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, big_settings, claimed_settings_size, read_only,
                                                      sizeof(read_only));
    ...
    static void test_master_cannot_write_too_many_bytes_to_a_register_with_single_transaction() {
        uint8_t big_settings[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        size_t claimed_settings_size = 2;
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, big_settings, claimed_settings_size, read_only,
                                                      sizeof(read_only));
    ...
    static void test_master_can_read_from_mutable_register() {
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, filled_settings, sizeof(filled_settings), read_only,
                                                      sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_master_can_read_from_multiple_mutable_registers() {
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, filled_settings, sizeof(filled_settings), read_only,
                                                      sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_master_cannot_read_from_non_existent_register() {
        uint8_t long_read_only[] = {0x0A, 0x0B, 0x0C, 0x0D, 0x11, 0x11, 0x11, 0x11};
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, settings, sizeof(settings), long_read_only,
                                                      sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_master_cannot_read_too_many_bytes_from_a_register() {
        size_t claimed_settings_size = 2;
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, filled_settings, claimed_settings_size, read_only,
                                                      sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_master_ignores_repeated_read_of_mutable_register() {
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, filled_settings, sizeof(filled_settings), read_only,
                                                      sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_master_cannot_write_to_readonly_register() {
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, settings, sizeof(settings), blank_read_only,
                                                      sizeof(blank_read_only));
        reg_slave.listen(address);
    ...
    static void test_master_can_read_from_readonly_register() {
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, settings, sizeof(settings), read_only, sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_master_can_read_from_multiple_readonly_registers() {
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, settings, sizeof(settings), read_only, sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_master_cannot_read_too_many_bytes_from_a_readonly_register() {
        uint8_t long_read_only[] = {0x0A, 0x0B, 0x0C, 0x0D, 0x11, 0x11, 0x11, 0x11};
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, settings, sizeof(settings), long_read_only,
                                                      sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_master_ignores_repeated_read_of_readonly_register() {
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, settings, sizeof(settings), read_only, sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_app_receives_callback_after_read() {
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, settings, sizeof(settings), read_only, sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_app_receives_callback_after_write() {
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, settings, sizeof(settings), read_only, sizeof(read_only));
        reg_slave.listen(address);
    ...
    static void test_app_receives_callback_after_write_with_register() {
        I2CRegisterSlave reg_slave = I2CRegisterSlave(*dummy, settings, sizeof(settings), read_only, sizeof(read_only));
        reg_slave.listen(address);
    ...
    I2CRegisterSlaveTest() : TestSuite(__FILE__) {};
};

// Define statics
DummyI2CSlave* I2CRegisterSlaveTest::dummy;
uint16_t I2CRegisterSlaveTest::address = 0xDD;
uint8_t I2CRegisterSlaveTest::settings[4] = {0x00, 0x00, 0x00, 0x00};
uint8_t I2CRegisterSlaveTest::filled_settings[4] = {0xAA, 0xBB, 0xCC, 0xDD};
uint8_t I2CRegisterSlaveTest::blank_read_only[4] = {0x00, 0x00, 0x00, 0x00};
uint8_t I2CRegisterSlaveTest::read_only[4] = {0x0A, 0x0B, 0x0C, 0x0D};

#endif //TEENSY_I2C_UNIT_TEST_I2C_REGISTER_SLAVE_TEST